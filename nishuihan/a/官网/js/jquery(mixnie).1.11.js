...
!function (t) {
    ...
    t.browser = t.browser || function () {
            var t = navigator.userAgent.toLowerCase(), e = /(webkit)[ \/]([\w.]+)/, n = /(opera)(?:.*version)?[ \/]([\w.]+)/, i = /(msie) ([\w.]+)/, o = /(mozilla)(?:.*? rv:([\w.]+))?/, r = e.exec(t) || n.exec(t) || i.exec(t) || t.indexOf("compatible") < 0 && o.exec(t) || [];
    ...
    jQuery.cookie = function (t, e, n) {
        ...
        document.cookie = [t, "=", encodeURIComponent(e), s, c, l, f].join("")
    }
}(jQuery), !function (t) {
    var e = function (t, e) {
        return t << e | t >>> 32 - e
        ...
        return e ^ (t | ~n)
    }, s = function (t, o, r, a, s, u, c) {
        return t = n(t, n(n(i(o, r, a), s), c)), n(e(t, u), o)
    }, u = function (t, i, r, a, s, u, c) {
        return t = n(t, n(n(o(i, r, a), s), c)), n(e(t, u), i)
    }, c = function (t, i, o, a, s, u, c) {
        return t = n(t, n(n(r(i, o, a), s), c)), n(e(t, u), i)
    }, l = function (t, i, o, r, s, u, c) {
        return t = n(t, n(n(a(i, o, r), s), c)), n(e(t, u), i)
    }, f = function (t) {
        for (var e, n = t.length, i = n + 8, o = (i - i % 64) / 64, r = 16 * (o + 1), a = Array(r - 1), s = 0, u = 0; n > u;)e = (u - u % 4) / 4, s = u % 4 * 8, a[e] = a[e] | t.charCodeAt(u) << s, u++;
        return e = (u - u % 4) / 4, s = u % 4 * 8, a[e] = a[e] | 128 << s, a[r - 2] = n << 3, a[r - 1] = n >>> 29, a
    }, d = function (t) {
        var e, n, i = "", o = "";
    ...
    t.extend(t, {
        md5: function (t) {
            var e, i, o, r, a, h, p, g, y, w = Array(), v = 7, x = 12, b = 17, _ = 22, j = 5, k = 9, D = 14, S = 20, z = 4, L = 11, C = 16, q = 23, T = 6, P = 10, E = 15, R = 21;
            for (t = m(t), w = f(t), h = 1732584193, p = 4023233417, g = 2562383102, y = 271733878, e = 0; e < w.length; e += 16)i = h, o = p, r = g, a = y, h = s(h, p, g, y, w[e + 0], v, 3614090360), y = s(y, h, p, g, w[e + 1], x, 3905402710), g = s(g, y, h, p, w[e + 2], b, 606105819), p = s(p, g, y, h, w[e + 3], _, 3250441966), h = s(h, p, g, y, w[e + 4], v, 4118548399), y = s(y, h, p, g, w[e + 5], x, 1200080426), g = s(g, y, h, p, w[e + 6], b, 2821735955), p = s(p, g, y, h, w[e + 7], _, 4249261313), h = s(h, p, g, y, w[e + 8], v, 1770035416), y = s(y, h, p, g, w[e + 9], x, 2336552879), g = s(g, y, h, p, w[e + 10], b, 4294925233), p = s(p, g, y, h, w[e + 11], _, 2304563134), h = s(h, p, g, y, w[e + 12], v, 1804603682), y = s(y, h, p, g, w[e + 13], x, 4254626195), g = s(g, y, h, p, w[e + 14], b, 2792965006), p = s(p, g, y, h, w[e + 15], _, 1236535329), h = u(h, p, g, y, w[e + 1], j, 4129170786), y = u(y, h, p, g, w[e + 6], k, 3225465664), g = u(g, y, h, p, w[e + 11], D, 643717713), p = u(p, g, y, h, w[e + 0], S, 3921069994), h = u(h, p, g, y, w[e + 5], j, 3593408605), y = u(y, h, p, g, w[e + 10], k, 38016083), g = u(g, y, h, p, w[e + 15], D, 3634488961), p = u(p, g, y, h, w[e + 4], S, 3889429448), h = u(h, p, g, y, w[e + 9], j, 568446438), y = u(y, h, p, g, w[e + 14], k, 3275163606), g = u(g, y, h, p, w[e + 3], D, 4107603335), p = u(p, g, y, h, w[e + 8], S, 1163531501), h = u(h, p, g, y, w[e + 13], j, 2850285829), y = u(y, h, p, g, w[e + 2], k, 4243563512), g = u(g, y, h, p, w[e + 7], D, 1735328473), p = u(p, g, y, h, w[e + 12], S, 2368359562), h = c(h, p, g, y, w[e + 5], z, 4294588738), y = c(y, h, p, g, w[e + 8], L, 2272392833), g = c(g, y, h, p, w[e + 11], C, 1839030562), p = c(p, g, y, h, w[e + 14], q, 4259657740), h = c(h, p, g, y, w[e + 1], z, 2763975236), y = c(y, h, p, g, w[e + 4], L, 1272893353), g = c(g, y, h, p, w[e + 7], C, 4139469664), p = c(p, g, y, h, w[e + 10], q, 3200236656), h = c(h, p, g, y, w[e + 13], z, 681279174), y = c(y, h, p, g, w[e + 0], L, 3936430074), g = c(g, y, h, p, w[e + 3], C, 3572445317), p = c(p, g, y, h, w[e + 6], q, 76029189), h = c(h, p, g, y, w[e + 9], z, 3654602809), y = c(y, h, p, g, w[e + 12], L, 3873151461), g = c(g, y, h, p, w[e + 15], C, 530742520), p = c(p, g, y, h, w[e + 2], q, 3299628645), h = l(h, p, g, y, w[e + 0], T, 4096336452), y = l(y, h, p, g, w[e + 7], P, 1126891415), g = l(g, y, h, p, w[e + 14], E, 2878612391), p = l(p, g, y, h, w[e + 5], R, 4237533241), h = l(h, p, g, y, w[e + 12], T, 1700485571), y = l(y, h, p, g, w[e + 3], P, 2399980690), g = l(g, y, h, p, w[e + 10], E, 4293915773), p = l(p, g, y, h, w[e + 1], R, 2240044497), h = l(h, p, g, y, w[e + 8], T, 1873313359), y = l(y, h, p, g, w[e + 15], P, 4264355552), g = l(g, y, h, p, w[e + 6], E, 2734768916), p = l(p, g, y, h, w[e + 13], R, 1309151649), h = l(h, p, g, y, w[e + 4], T, 4149444226), y = l(y, h, p, g, w[e + 11], P, 3174756917), g = l(g, y, h, p, w[e + 2], E, 718787259), p = l(p, g, y, h, w[e + 9], R, 3951481745), h = n(h, i), p = n(p, o), g = n(g, r), y = n(y, a);
            var I = d(h) + d(p) + d(g) + d(y);
    ...
    t.chainclude = function (e, n) {
        var i = function (o, r) {
            ...
            for (var a in e) {
                ...
                var s = 0;
                for (var u in e)s++;
                return 0 == s ? t.isFunction(n) ? n(r) : null : t.chainclude.load(e, i)
            }
        };
    ...
    nie.site = nie.site || function () {
            ...
            }, o = {"test.nie": 1, "yixiu.game": 1};
            if (e)return o[e[1].substring(0, e[1].length - 1)] ? null : e[1].substring(0, e[1].length - 1).toLowerCase();
    ...
    var n = function (t, n) {
        ...
        "PENDING" === r._status && setTimeout(function () {
            for (r._status = t, o = "FULFILLED" === r._status, queue = r[o ? "_resolves" : "_rejects"]; i = queue.shift();)n = i.call(r, n) || n;
            r[o ? "_value" : "_reason"] = n, r._resolves = r._rejects = e
        })
    }, i = function (t) {
        ...
        var e = this;
        e._value, e._reason, e._status = "PENDING", e._resolves = [], e._rejects = [];
        var o = function (t) {
            n.apply(e, ["FULFILLED"].concat([t]))
        }, r = function (t) {
            n.apply(e, ["REJECTED"].concat([t]))
        };
        t(o, r)
    };
    i.prototype.then = function (t, e) {
        ...
        return new i(function (i, o) {
            function r(e) {
                var n = "function" == typeof t && t(e) || e;
                n && "function" == typeof n.then ? n.then(function (t) {
                    i(t)
                }, function (t) {
                    o(t)
                }) : i(n)
        ...
        if (!Array.isArray(t))throw new TypeError("You must pass an array to all.");
        return i(function (e, n) {
            function i(t) {
                return function (e) {
                    r(t, e)
            ...
            for (var a = 0, s = [], u = t.length, c = u; u > a; a++)t[a].then(i(a), o)
        })
    }, i.race = function (t) {
        if (!Array.isArray(t))throw new TypeError("You must pass an array to race.");
        return i(function (e, n) {
            function i(t) {
                e(t)
            }
            ...
            for (var r = 0, a = t.length; a > r; r++)t[r].then(i, o)
        })
    }, "undefined" == typeof t.Promise && (t.Promise = i)
}(window), !function ($) {
    function unique(t) {
    ...
    function packProcess(storeList) {
        for (var keyVal = {}, i = 0; i < storeList.length; i++) {
            var name = _defineList[storeList[i]] || storeList[i], lastName = storeList[i].split(".");
    ...
    var _defineList = {}, _host = $.host + "/comm/js/", _nameHash = {
        ...
        "nie.util.gameorder_m": 22,
        "nie.util.gameorder": 22,
        "nie.util.map3d": 5,
        "nie.util.metro": 0,
        "nie.util.moretips": 12
    ...
    nie.define = function (t, e) {
        ...
        var e = "", n = 0, o = t;
        if (t = "string" == typeof t ? [t] : t, t = unique(t), t = filter(t, function (t) {
                return _defineList[t] ? !1 : !0
            }), !t || !t.length)return packProcess(o);
        for (t = t.sort(function (t, e) {
            return t > e
        }), i = 0; i < t.length; i++)e += t[i].replace(/\./g, "/") + ".js,", _verHash[t[i]] && (n += _verHash[t[i]]);
        return e = _host + "??" + e + "v=" + n + ".js", new Promise(function (n) {
            $.include(e, function () {
...
var ADBase = function (t) {
    ...
    function n(t) {
        for (var e = [], n = [], o = !!t[0].noCache, r = t[0].time || 15e3, s = (new Date, 0); s < t.length; s++)e.push(t[s].pos), n.push(t[s].callback);
        e = e.join(","), f({
            url: p.getData, data: "pos=" + e, time: r, success: function (t) {
                if (t.succ && "00" == t.result.code) {
                    var r = t.result.content;
                    i(r, e, n, o), setTimeout(function () {
                        u(e)
                    }, 1e3)
                } else a(e, n), "undefined" != typeof BJ_REPORT && BJ_REPORT.report("[" + l.site + "][adconfig_error][interface_fail][data:" + d.stringify(t) + "]")
            }, error: function () {
                a(e, n)
            }
        })
    ...
    function i(t, e, n, i) {
        ...
        var a = i ? {} : o(e);
        a = r(a, t), i || m.set(e, d.stringify(a));
    ...
    function s() {
        c(".adbase-ctn").each(function (t, e) {
            c(e).contents().length < 1 && c(e).css("background", "url(" + c.host + "/comm/js/nie/util/img/error.png) center center no-repeat")
        })
    }
    ...
    var c = t.jQuery || t.Zepto, l = t.nie, f = t.__GetScript, d = t.JSON, m = t.LocalData, h = (t.ADData, "//a.game.163.com"), p = {
...
!function (t) {
    nie.util.topBar = nie.util.topBar || function () {
            !nie.config.topBar.hasRun && document.getElementById("NIE-topBar") && (nie.config.topBar.hasRun = !0, t.include(t.host + "/comm/nie.topBar/js/topBar.v2.last.js")), (document.getElementById("NIE-topBar") || document.getElementById("NIE-topBar-include")) && nie.util.addStyle(".adbase-ctn{background:url(" + t.host + "/comm/js/nie/util/img/loading.png) center center no-repeat;}")
        }
}(jQuery), !function (t) {
    nie.util.copyRight = nie.util.copyRight || function () {
            function e() {
                var e = "", r = t(window).width(), s = function (t) {
                ...
                0 == n.length && i.length > 0 && (e = "m"), t.ajax({
                    ...
                    success: function (n) {
                        if (n.success)t(function () {
                            2 == nie.config.copyRight.getStyle() && (n.result.copyright = n.result.copyright.replace(/(\/images\/([^\.\/]*)\.)\d{1}(\.png)/gi, "$12$3")), s(n.result.copyright)
                    ...
                    error: function (t) {
                        s(e, "\u7248\u6743\u52a0\u8f7d\u5931\u8d25\uff1a" + JSON.stringify(t))
                    }
                })
            }

            var n = t("#NIE-copyRight"), i = t(".NIE-copyRight_m"), o = t("#NIE-warning-tips"), r = navigator.userAgent, a = +(r.match(/MSIE (\d+)/) && RegExp.$1), s = /cbg.163.com|gift.163.com/, u = s.test(window.location.host);
...
}(jQuery), BJ_REPORT.tryJs().spyAll(), function (t) {
    t(function () {
    ...
    function e() {
        ...
        var e = 1, n = window, i = document.documentElement || document.body, o = n.devicePixelRatio;
        return o && 1 > o && o > 0 ? (e = o, i.dpr = o) : isNaN(screen.deviceXDPI) || isNaN(screen.logicalXDPI) ? n.outerWidth > 0 && n.innerWidth > 0 && (i.outerWidth = n.outerWidth, i.innerWidth = n.innerWidth, e = n.outerWidth / n.innerWidth) : e = screen.deviceXDPI / screen.logicalXDPI, i.zoom = e, 1 !== t(e, 1)
    }
    ...
    function n() {
        ...
        t(document.body).append(e), t("#_js_neteaes_tips a").click(function () {
