!function (t, r) {
    ...
    return function (t) {
        ...
        var o = Object.assign || function (t) {
            ...
            script: function (t, r) {
                var n = this;
                i(t, {charset: "UTF-8"}, function (e, o) {
                    if (e) {
                        var i = new Error("Failed to load script(" + t + ")." + e.message);
                        return i.data = {url: t, retry: !!n._options.retry}, void r(i)
                    }
                    r(o)
                })
            }, image: function (t, r) {
                var n = this, e = document.createElement("img");
                e.onload = function () {
                    e.onload = e.onerror = null, r({width: e.width, height: e.height, src: t})
                }, e.onerror = function (o) {
                    e.onload = e.onerror = null;
                    var i = new Error("Failed to load image(" + t + ")." + o.message);
                    i.data = {url: t, retry: !!n._options.retry}, r(i)
                }, e.src = t
            }, api: function (t, r, n) {
                var e = this;
                u(t, n, function (n, o) {
                    if (n) {
                        ...
                        return i.data = {url: t, retry: !!e._options.retry}, void r(i)
                    }
                    r(o)
        ...
        c(p, a), Object.assign(p.prototype, {
            load: function () {
                ...
                window.setTimeout(function () {
                    var r = String(t.url), n = new Error("Timeout: failed to request " + t.type + "(" + r + ").");
                    n.data = {url: r}, t.resolve(n)
                }, this.timeout)
            }
        }), p.SUPPORTS = f;
        var h = function (t) {
            f.hasOwnProperty(t) && (p[t] = function (r) {
                var n = r.disableRetry, i = r.onTryError, c = e(r, ["disableRetry", "onTryError"]);
                if (n) {
                    var u = c.url;
                    return Array.isArray(u) && (u = u[0] || ""), new p(o({}, c, {url: u, type: t}))
                }
                var s = l(r.url), f = new a, h = function d() {
                    var r = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0, n = s[r], e = new p(o({}, c, {
                        type: t,
                        url: n,
                        retry: r > 0
                    }));
                    e.then(function (t) {
                        ...
                        var a = s.length;
                        r < a - 1 ? d(r + 1) : r === a - 1 && (e.data = o({}, e.data, {url: String(s)}), f.resolve(e)), "function" == typeof i && i(e, {
                            type: t,
                            urls: s,
                            url: n,
                            index: r
        ...
        var i = "pending", a = "fullfilled", c = "rejected";
        ...
        t.exports = function (t) {
            var r = t.protocol, n = void 0 === r ? "" : r, e = t.host, o = void 0 === e ? "" : e, i = t.port, a = void 0 === i ? "" : i, c = t.path, u = void 0 === c ? "" : c, s = t.search, l = void 0 === s ? "" : s, f = t.hash, p = void 0 === f ? "" : f;
        ...
        t.exports = function (t) {
            return function (r, n, a, c) {
                Object.assign(n, {referer: i()});
                var u = e({}, t, c, {url: r, payload: n});
        ...
        t.exports = function (t, r) {
            return function (n, s) {
                var l = s.type, f = s.url, p = s.index, h = {
                    script: a,
                    image: c,
                    api: u
                }, d = new i(h[l], n.message, e({}, r, {url: f}));
                o(d, t, {times: p + 1})
            }
        }
    }, function (t, r) {
        ...
        var o, i = n(5), a = n(4), c = n(1), u = c.REQUEST_SCRIPT_ERROR, s = c.REQUEST_API_ERROR, l = c.REQUEST_IMG_ERROR, f = n(3), p = n(2), h = (o = {}, e(o, s, "api"), e(o, l, "image"), e(o, u, "script"), o), d = null;
        t.exports = function (t, r, n) {
            var e = r.protocol, o = r.apiServer, c = r.__serverConfig__, u = r.captchaId, s = r.timeout, l = new f, y = function (t) {
                var r = "/api/v2/collect";
                return Array.isArray(t) ? t.map(function (t) {
                    return a({protocol: e, host: t, path: r})
                }) : a({protocol: e, host: t, path: r})
            }, v = y(o || c.apiServer || ["c.dun.163yun.com", "c.dun.163.com"]), m = i({
                timeout: s,
                disableRetry: !0
            }), _ = t.data, g = Object.assign({
                id: u,
                token: _.token || "",
                type: h[t.code] || "other",
            ...
            var E = new p({url: e + "://nstool.netease.com/ip.js", timeout: s});
            return E.then(function (t) {
                ...
                Object.assign(g, d), m(v, g, function (t, r) {
                    if (t || r.error) {
                        ...
                        return n.data = {url: v}, void l.resolve(n)
                    }
                    l.resolve()
                })
            }), l
        ...
        t.exports = e, Object.assign(e.prototype, {
            on: function (t, r) {
                ...
                var n = this, e = function o() {
                    r.apply(void 0, arguments), n.off(t, o)
                };
                return this.on(t, e)
            }, off: function (t, r) {
                if (t)if (t && !r)this._events[t] = []; else {
                    var n = this._events[t] || [], e = n.indexOf(r);
                    e > -1 && n.splice(e, 1)
                } else this._events = {};
                return this
            }, emit: function (t) {
                for (var r = arguments.length, n = Array(r > 1 ? r - 1 : 0), e = 1; e < r; e++)n[e - 1] = arguments[e];
                var i = this._events[t] || [], a = new o, c = {}, u = function s(t) {
                    var r = i[t];
        ...
        function e(t, r, n) {
            ...
            var a = window.location.protocol.replace(":", ""), h = {
            ...
            var d = function (r) {
                ...
                return Array.isArray(r) ? r.map(function (r) {
                    return c({protocol: t.protocol, host: r, path: n})
                }) : c({protocol: t.protocol, host: r, path: n})
            }, y = "loader_plugins", v = p[y] || i.script({
                    id: y,
                    url: d(t.staticServer || ["cstaticdun.126.net", "cstatic.dun.163yun.com"]),
                    timeout: t.timeout,
                    onTryError: l(t)
                });
            !p[y] && (p[y] = v), v.then(function () {
                var i = new o({captchaConfig: t, cache: p});
                i._hooks = {onload: r, onerror: n}, e.apply(i), i.run()
            })["catch"](function (t) {
                p[y] = null, n(new u(s, t.message, t.data))
            })
        }

        var o = n(13), i = n(2), a = n(3), c = n(4), u = n(1), s = u.REQUEST_SCRIPT_ERROR, l = n(6), f = !1, p = {};
        e.use = function (t) {
            this._plugins || (this._plugins = []);
            var r = t.constructor, n = !!r.singleton, e = this._plugins.map(function (t) {
        ...
        l(o, s), Object.assign(o.prototype, {
            run: function () {
                ...
                var r = this, n = this._captchaConfig, e = n.captchaId, o = n.protocol, u = n.timeout, s = n.apiServer, l = n.__serverConfig__;
                null == s && (s = ["c.dun.163yun.com", "c.dun.163.com"]);
                var f = function () {
                    var t = "/api/v2/getconf";
                    return Array.isArray(s) ? s.map(function (r) {
                        return c({protocol: o, host: r, path: t})
                    }) : c({protocol: o, host: s, path: t})
                }, d = f(), y = {id: e}, m = {timeout: u}, _ = a(i({}, m, {onTryError: p(this._captchaConfig)})), g = function () {
                    _(d, y, function (n, e) {
                        if (n || e.error) {
                            var o = n ? n.message : e.msg, i = new Error(o + " (" + d + ")");
                            return i.data = {url: d}, void r.catchError(i, h)
                        }
                        var a = function (t) {
                ...
                this.emit("before-config", {params: y, jsonpOpts: m}).then(g)["catch"](function (t) {
                    return r.catchError(t)
                })
            }, loadResources: function () {
                var t = this, r = this._captchaConfig, n = r.protocol, e = r.timeout, o = r.staticServer, i = r.__serverConfig__, a = function (t, r) {
                    return Array.isArray(t) ? t.map(function (t) {
                        return c({protocol: n, host: t, path: r})
                    }) : c({protocol: n, host: t, path: r})
                };
                this.emit("before-load", o).then(function () {
                    var r = i.resources.map(function (r) {
                        var n = a(o, r), i = Array.isArray(n) ? n[0] : n, c = t._cache[i];
                        return c || (c = f.script({
                            id: i,
                            url: n,
                            timeout: e,
        ...
        Array.prototype.indexOf || (Array.prototype.indexOf = function (t, r) {
            ...
            var e = Object(this), o = e.length >>> 0;
            if (0 === o)return -1;
            var i = +r || 0;
        ...
        t.exports = function (t, r, i) {
            var a = document.head || document.getElementsByTagName("head")[0], c = document.createElement("script");
            "function" == typeof r && (i = r, r = {}), r = r || {}, i = i || function () {
                }, c.type = r.type || "text/javascript", c.charset = r.charset || "utf8", c.async = !("async"in r) || !!r.async, c.src = t, r.attrs && n(c, r.attrs), r.text && (c.text = "" + r.text);
